...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL_1 = "NIM";
    private static final String COL_2 = "NAMA";
    private static final String COL_3 = "TTL";
    private static final String COL_4 = "JENIS";
    ...
    public boolean insertData(int nim, String nama, String ttl, String jenis, String alamat) {
    ...
    public boolean updateData(String nim, String nama, String ttl, String jenis, String alamat) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_1, nim);
        contentValues.put(COL_2, nama);
